...
p1
ggsave(filename = "/research_jude/rgs01_jude/groups/yu3grp/projects/scRNASeq/yu3grp/scMINER/NG_Revision/QPan/CITEseq/04_Hao/03_evaluation/03_diffAnalysis/02_bubblePlot.selectedMarker_FC1.5.Zscore.pdf",
...
p2 <- ggplot(ms.sel, aes(x = geneSymbol, y = cellType, colour = log2FC_vsRest, size = pct)) + geom_point() + facet_wrap(vars(modalityNew), nrow = 3) + sc +
  ...
  scale_x_discrete(limits = c(marker.b, marker.cd4t, marker.cd8t, marker.cm, marker.nk))
p2
ggsave(filename = "/research_jude/rgs01_jude/groups/yu3grp/projects/scRNASeq/yu3grp/scMINER/NG_Revision/QPan/CITEseq/04_Hao/03_evaluation/03_diffAnalysis/02_bubblePlot.selectedMarker_FC1.5.log2FC.pdf",
...
p3 <- ggplot(d, aes(x = CellType, y = Cluster, colour = MarkerScore, size = ExpressionPercentage)) + geom_point() + 
  ...
  scale_x_discrete(limits = c(marker.b, marker.cd4t, marker.cd8t, marker.cm, marker.nk))
p3
ggsave(filename = "/research_jude/rgs01_jude/groups/yu3grp/projects/scRNASeq/yu3grp/scMINER/NG_Revision/QPan/CITEseq/04_Hao/03_evaluation/03_diffAnalysis/02_bubblePlot.selectedMarker_FC1.5.quantification.pdf",
